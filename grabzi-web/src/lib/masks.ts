// Маски ввода GRABZI (порт из JOOZ): имя, телефон ОАЭ, номер авто.
// Применяются в onChange — пользователь сразу видит отформатированное значение.
...
/** Телефон ОАЭ в каноничном виде для бэкенда: «+9715XXXXXXXX». */
