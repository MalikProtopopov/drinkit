...
const PDF_OUT = path.join(REPO_ROOT, "docs", "КП-Juicy.pdf");
...
code { font-family: ui-monospace, Menlo, monospace; font-size: 9.5pt; background: var(--beige); padding: 1px 5px; border-radius: 3px; }
...
.cover-brand strong { font-size: 16pt; }
.cover-brand-sub { font-size: 9pt; color: var(--ink-soft); letter-spacing: 0.1em; text-transform: uppercase; }
...
<section class="cover">
  ...
  <div class="cover-main">
    <div style="font-size: 10pt; color: var(--ink-soft); letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 8pt;">Коммерческое предложение №&nbsp;КП-JUICY-2026-001</div>
...
await page.pdf({
  ...
  footerTemplate: `
    <div style="width:100%; font-family: Manrope, sans-serif; font-size: 8pt; color: #888; padding: 0 16mm; display:flex; justify-content: space-between;">
